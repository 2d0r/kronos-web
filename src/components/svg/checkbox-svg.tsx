...
export default function CheckboxSVG ({
    ...
    } else if (type === 'task' && repeat) {
        if ( statusDisplay === 'checked' ) {
            return (<svg width={width} height={height} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <mask id="mask0_195_3493" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="0" y="0" width="36" height="36">
                <rect width="36" height="36" fill="#D9D9D9"/>
                </mask>
                <g mask="url(#mask0_195_3493)">
                <path d="M15.9 24.3L26.475 13.725L24.375 11.625L15.9 20.1L11.625 15.825L9.52502 17.925L15.9 24.3Z" fill={fill}/>
                <path d="M5.38125 30.6188C5.96875 31.2063 6.675 31.5 7.5 31.5H16V30V28.5H7.5V7.5H28.5V28.5H21V26L17 30L21 34V31.5H28.5C29.325 31.5 30.0313 31.2063 30.6188 30.6188C31.2063 30.0313 31.5 29.325 31.5 28.5V7.5C31.5 6.675 31.2063 5.96875 30.6188 5.38125C30.0313 4.79375 29.325 4.5 28.5 4.5H7.5C6.675 4.5 5.96875 4.79375 5.38125 5.38125C4.79375 5.96875 4.5 6.675 4.5 7.5V28.5C4.5 29.325 4.79375 30.0313 5.38125 30.6188Z" fill={fill}/>
                </g>
            </svg>)
        } else {
            return (<svg width={width} height={height} viewBox='0 0 36 36' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <mask id='mask0_195_3468' style={{maskType: 'alpha'}} maskUnits='userSpaceOnUse' x='0' y='0' width='36' height='36'>
                <rect width='36' height='36' fill='#D9D9D9'/>
                </mask>
                <g mask='url(#mask0_195_3468)'>
                <path d='M5.38125 30.6188C5.96875 31.2063 6.675 31.5 7.5 31.5H16V30V28.5H7.5V7.5H28.5V28.5H21V26L17 30L21 34V31.5H28.5C29.325 31.5 30.0313 31.2063 30.6188 30.6188C31.2063 30.0313 31.5 29.325 31.5 28.5V7.5C31.5 6.675 31.2063 5.96875 30.6188 5.38125C30.0313 4.79375 29.325 4.5 28.5 4.5H7.5C6.675 4.5 5.96875 4.79375 5.38125 5.38125C4.79375 5.96875 4.5 6.675 4.5 7.5V28.5C4.5 29.325 4.79375 30.0313 5.38125 30.6188Z' fill={fill}/>
                </g>
            </svg>);
        }
