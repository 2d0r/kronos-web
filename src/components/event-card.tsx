...
export default function EventCard({ event, mindset, className, isTucked = false, greyed = false } : EventCardProps) {
    ...
    return (!isTucked ? <>
        <div className={clsx(className, 
            'text-white rounded-2xl flex flex-col justify-between items-center text-center cursor-pointer p-4 md:w-[350px] w-[90vw]'
        )}
        style = {{
        ...
        <div className={clsx(className, 
            'text-white rounded-2xl flex flex-col items-center text-center p-4 md:w-[350px] w-[90vw]',
