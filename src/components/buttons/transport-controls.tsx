...
import { AdjustmentsVerticalIcon, PauseCircleIcon, PauseIcon, PlayCircleIcon, XMarkIcon } from '@heroicons/react/24/outline';

export default function TransportControls ({ eventId, taskId, context, className, mindsetColour }: { 
    eventId: string | undefined, 
    taskId: string | undefined,
    context?: 'doingEvent' | 'timeline', 
    className?: string, 
    ...
    initial={{ opacity: 1 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
        { context === 'doingEvent' && <>
            ...
            <ShuffleIcon width={48} color={mindsetColour} />
